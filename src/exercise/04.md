...
- Awesome to see the list of how Babel distinguishes and interpolates a tag name
  as either a string or a component reference.
- Also nice to try out propTypes. Always used TypeScript with React so it wasn't
  a necessity. I've seen the syntax many times but it's always something else to
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=akd%40akd.io).
