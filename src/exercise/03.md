...
- I knew you could add babel as using a script tag as in this exercie, but never
  tried it before now. Super cool and an awesome way to get beginners up and
  running with learning by doing. Might make use of this myself in the future
  when teaching others, or when making very simple samples on codepen or
  codesandbox.
- The Babel repl is awesome to play around with, great resource!
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=akd%40akd.io).
